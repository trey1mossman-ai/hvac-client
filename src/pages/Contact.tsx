    ...
    <>
      ...
      <div className="bg-soft-beige py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-black text-center mb-8 text-deep-charcoal uppercase tracking-wider">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-bold mb-2 text-deep-charcoal uppercase">Phone</h3>
              <a 
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mb-2 text-deep-charcoal uppercase">Email</h3>
              <a 
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mb-2 text-deep-charcoal uppercase">Location</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold mb-2 text-deep-charcoal uppercase">Hours</h3>
